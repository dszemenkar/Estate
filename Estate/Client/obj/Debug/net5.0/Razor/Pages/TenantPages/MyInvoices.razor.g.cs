...
__builder.AddContent(20, LoadingText);
...
__builder.AddContent(27, entry.InvoiceNo);
...
__builder.AddContent(30, entry.InvoiceDate.ToString("yyyy-MM-dd"));
...
__builder.AddContent(33, entry.InvoiceDate.AddDays(30).ToString("yyyy-MM-dd"));
...
__builder.AddContent(42, entry.Status);
...
__builder.AddContent(50, entry.MarkedAsPaid.ToString("yyyy-MM-dd"));
